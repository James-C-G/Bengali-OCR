...
def build_model():
    pickle_in = open(EKUSH_DIR + "male/modifiers/x.pickle", "rb")
    x = pickle.load(pickle_in)

    pickle_in = open(EKUSH_DIR + "male/modifiers/y.pickle", "rb")
    ...
    # Output layer
    model.add(layers.Dense(10, activation='softmax'))  # 10 modifiers for ekush
    ...
    tf.keras.models.save_model(model, "models/modifier_model.h5")
